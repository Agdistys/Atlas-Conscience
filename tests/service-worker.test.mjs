...
test('cache upgrade preserves other applications and the current shell', async () => {
  ...
  vm.runInNewContext(source, {
    ...
    caches: {
      keys: async () => ['dragonroute-v3-shell-4', 'dragonroute-v3-shell-5', 'dragonroute-v3-shell-6', 'dragonroute-v3-shell-7', 'agora-v1', 'autre-cache'],
  ...
  await activation;
  assert.deepEqual(removed, ['dragonroute-v3-shell-4', 'dragonroute-v3-shell-5', 'dragonroute-v3-shell-6']);
