...
test('version testable, identifiee et sans installation PWA', async ({ page }) => {
  ...
  await page.addInitScript(() => {
    ...
    localStorage.setItem('dragonroute.profile.v1.public',JSON.stringify({version:1,vehicle:{name:'Profil public',type:'car',fuel:'E85',cons:10,liters:60},addresses:[],stations:[]}));
